...
class CustomFieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create custom_field" do
    assert_difference('CustomField.count') do
      post custom_fields_url, params: { custom_field: { descriptions: @custom_field.descriptions, element: @custom_field.element, format: @custom_field.format, name: @custom_field.name } }
    end
  ...
  test "should update custom_field" do
    patch custom_field_url(@custom_field), params: { custom_field: { descriptions: @custom_field.descriptions, element: @custom_field.element, format: @custom_field.format, name: @custom_field.name } }
