...
export function ReplenishButton({ consumable, disabled, tooltipMessage, ...props }: ReplenishButtonProps) {
			...
			>
				...
				>
					<Grid>
						...
						<Grid.Col>
							<FormConsumer<typeof defaultData>>{ (form) => (
								<Checkbox
									label="Create Purchase Order"
									onChange={ () => handleTogglePurchaseOrder(form) }
								/>
							) }</FormConsumer>
						</Grid.Col>
