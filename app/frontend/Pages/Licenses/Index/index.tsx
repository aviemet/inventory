...
const Index = ({ licenses }: { licenses: Schema.License[] }) => {
	return (
		<>
			<Head title="Licenses"></Head>

			<section className="h-full flex flex-col">
				<div className="flex justify-between">
					<h1 className="inline-block align-text-top md:align-middle">Licenses</h1>
					<div>
				...
				<Table.Table scroll selectable rows={ licenses } fixed={ false }>
					<Table.Head>
						<Table.Row>
